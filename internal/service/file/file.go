...
func (s Service) Upload(ctx context.Context, file *multipart.FileHeader, folder string) (string, *pkg.Error) {
	if file == nil {
		return "", nil
	}
...
func (s Service) Delete(ctx context.Context, url string) *pkg.Error {
...
func (s Service) MultipleUpload(ctx context.Context, files []*multipart.FileHeader, folder string) ([]string, *pkg.Error) {
	var links []string
